...
var displayResults = function displayResults(recipes) {
    var html = recipes.map(function (recipe) {
        ...
        existingIngredients.forEach(function (existing) {
            missingIngredients = missingIngredients.concat((0, _utilsJs.fuzzyMatch)(recipe.ingredients, existing).filter(function (ingredient) {
