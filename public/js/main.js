    ...
    $('.js-recipe--checkout').bind('click', function (event) {
        ...
        labels.bind('click', function (_event) {
            ...
            $.get('/api/cart/add?item=' + item, function (res) {
                ...
                link.val('Nicolas Brugneaux invite you for a shared dinner. You shall split the amount, click here to pay them, directly without hassle with Paypal. https://www.paypal.com/cgi-bin/webscr?business=nicolas.brugneaux@gmail.com&cmd=_xclick&currency_code=USD&amount=' + amount / 2 + '&item_name=Invitation%20from%20Nicolas%20for%20a%20shared%20dinner');
