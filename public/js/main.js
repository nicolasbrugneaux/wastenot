    ...
    $('.js-recipe--checkout').bind('click', function (event) {
        ...
        labels.bind('click', function (_event) {
            ...
            $.get('/api/cart/add?item=' + item, function (res) {
                ...
                link.val('https://www.paypal.com/cgi-bin/webscr?' + 'business=' + escape('nicolas.brugneaux@gmail.com') + '&amp;' + 'cmd=_xclick&amp;currency_code=EUR&amp;' + 'amount=' + escape(amount) + '&amp;' + 'item_name=' + escape('Invitation from Nicolas Brugneaux for dinner.'));
