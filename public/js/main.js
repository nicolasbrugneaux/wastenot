...
var $searchTextArea = (0, _jquery2['default'])('.js-recipe--search');
var $searchButton = (0, _jquery2['default'])('.js-recipe--search--button');
var $searchAdvanced = (0, _jquery2['default'])('.js-recipe--search--advanced');
...
var searchApi = function searchApi(term) {
    return _baconjs2['default'].fromPromise(_jquery2['default'].ajax('/api/recipes?q=' + term));
};
