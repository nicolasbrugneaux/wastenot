...
var displayResults = function displayResults(recipes) {
    ...
    $('.js-recipe--checkout').bind('click', function (event) {
        ...
        var inviteDiv = btn.parent().parent().find('.js-recipe--invite');
        var inviteAmount = fragment.find('.js-recipe--invite-total, #invite--modal .js-recipe--invite-total');
        var inviteBtn = inviteDiv.find('.js-recipe--invite-btn');
        var link = $('.js-paypal-link');
        ...
        labels.bind('click', function (_event) {
            ...
            $.get('/api/cart/add?item=' + item, function (res) {
                ...
                link.val('https://www.sandbox.paypal.com/cgi-bin/webscr?' + 'business=' + escape('nicolas.brugneaux@gmail.com') + '&amp;' + 'cmd=_xclick&amp;currency_code=EUR&amp;' + 'amount=' + escape(amount) + '&amp;' + 'item_name=' + escape('Invitation from Nicolas Brugneaux for dinner.'));
        ...
        inviteBtn.bind('click', function (_event) {});
